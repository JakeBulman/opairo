        ...
        <Layout>
            <Row className="px-4 pb-4">
                <Card className="pb-3">
                    { profile ? 
                    <>
                        <Card.Header className="text-white fw-bold pt-4">Your Profile</Card.Header>
                    ...
                    { referrer_profile ? 
                    <>    
                        <Card.Header className="text-white fw-bold pt-4">Your Referrer</Card.Header>              
                    ...
                    { account.user_type === '2' ?
                    <>    
                        <Card.Header className="text-white fw-bold pt-4">New Event</Card.Header>              
                    ...
                    : null }
                    <>    
                        <Card.Header className="text-white fw-bold pt-4">Latest Events</Card.Header>              
